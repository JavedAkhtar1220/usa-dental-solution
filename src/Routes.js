...
import Amount from './example-pages/Amount';
import Deposit from './example-pages/Deposit';
import DashboardDeposit from './example-pages/DashboardDeposit';
